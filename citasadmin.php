...
<title>Alta Performance</title>
  <body>
    ...
    <div class="container-fluid col-11">
      <div class="progress progress-bar progress-bar-striped progress-bar-animated" style="width: 100%;height: 35px; background-color: rgba(255,0,0,.75);font-size: 25px; color: black;"><b>...Citas del mes...</b></div>
      <!--**********termina el titulo***********-->
<?php
...
$registros=1;
    ...
    <br>
      <table  align="center" border="1" style="background-color: rgba(255,255,255,.7);">
        ...
        <td style="background-color: rgba(255,128,0,0.7);">Marca</td>
        <td style="background-color: rgba(255,128,0,0.7);">vehiculo</td>
        <td style="background-color: rgba(255,128,0,0.7);">modelo</td>
        <td style="background-color: rgba(255,128,0,0.7);">Servicio</td>
        <td style="background-color: rgba(255,128,0,0.7);">Fecha</td>
        <td style="background-color: rgba(255,128,0,0.7);">Hora</td>
        </tr>
...
<div class = "row justify-content-center">
    <img src = "imgs/audi.jpg" style="width: 500px;">
    </div>
